...
exports.initInputObserver = exports.initObservers = void 0;
...
function initStyleSheetObserver(cb) {
    var restoreInsertRule = (0, browser_core_1.instrumentMethodAndCallOriginal)(CSSStyleSheet.prototype, 'insertRule', {
        before: function (rule, index) {
            if ((0, serializationUtils_1.hasSerializedNode)(this.ownerNode)) {
                cb({
                    id: (0, serializationUtils_1.getSerializedNodeId)(this.ownerNode),
                    adds: [{ rule: rule, index: index }],
                });
            }
        },
    }).stop;
    var restoreDeleteRule = (0, browser_core_1.instrumentMethodAndCallOriginal)(CSSStyleSheet.prototype, 'deleteRule', {
