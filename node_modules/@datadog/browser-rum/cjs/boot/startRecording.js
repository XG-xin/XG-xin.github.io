...
function startRecording(lifeCycle, configuration, sessionManager, viewContexts, worker) {
    var _a = (0, segmentCollection_1.startSegmentCollection)(lifeCycle, configuration.applicationId, sessionManager, viewContexts, function (data, metadata, rawSegmentSize, flushReason) {
        return (0, send_1.send)(configuration.sessionReplayEndpointBuilder, data, metadata, rawSegmentSize, flushReason);
