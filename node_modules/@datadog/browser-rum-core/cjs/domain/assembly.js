        ...
        if (session && viewContext && urlContext) {
            ...
            var rumContext = {
                _dd: {
                    ...
                    browser_sdk_version: (0, browser_core_1.canUseEventBridge)() ? "4.7.1" : undefined,
                },
                application: {
            ...
            if (!(0, browser_core_1.isExperimentalFeatureEnabled)('sub-apps')) {
            ...
            var serverRumEvent = (needToAssembleWithAction(rawRumEvent) && actionId
                ? (0, browser_core_1.combine)(rumContext, urlContext, viewContext, { action: { id: actionId } }, rawRumEvent)
