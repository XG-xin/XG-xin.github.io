...
var viewContexts_1 = require("../domain/viewContexts");
...
function startRum(configuration, getCommonContext, recorderApi, initialViewOptions) {
    ...
    internalMonitoring.setExternalContextProvider(function () {
        ...
        }, viewContexts.findView(), { view: { name: null } });
    });
...
function startRumEventCollection(lifeCycle, configuration, location, sessionManager, locationChangeObservable, domMutationObservable, getCommonContext) {
    ...
    (0, assembly_1.startRumAssembly)(configuration, lifeCycle, sessionManager, viewContexts, urlContexts, actionContexts, getCommonContext);
    return {
        viewContexts: viewContexts,
